...
public class CommandLineEntrance {
	...
	public static void buyCrop() {
		...
		while (isOutLoop == false) {
			if (isNumeric(index) && (Integer.parseInt(index) <= 5 && Integer.parseInt(index) >= 1)) {
				...
				if (isNumeric(number)) {
					Controller.buySeed(crops[Integer.parseInt(index)], Integer.parseInt(number));
					break;
				}
			} else {
				break;
	...
	public static void buyAnimal() {
		...
		while (isOutLoop == false) {
			if (isNumeric(index) && (Integer.parseInt(index) <= 3 && Integer.parseInt(index) >= 1)) {
				...
				String number = input1.nextLine();
				if (isNumeric(number)) {
					Controller.buyAnimal(animals[Integer.parseInt(index)], Integer.parseInt(number));
					break;
				}
			} else {
				break;
	...
	public static void buyItems() {
		...
		while (isOutLoop == false) {
			if (isNumeric(index) && (Integer.parseInt(index) <= 3 && Integer.parseInt(index) >= 0)) {
				...
				String number = input1.nextLine();
				if (isNumeric(number)) {
					Controller.buyItems(items[Integer.parseInt(index)], Integer.parseInt(number));
					break;
				}
			} else {
				break;
	...
	public static void playWithAnimals() {
		...
		if (isNumeric(index) && (Integer.parseInt(index) <= 3 && Integer.parseInt(index) >= 0)) {
			Controller.playWithAnimal(animals[Integer.parseInt(index)],0);
		}
	...
	public static void feedAnimals() {
		...
		if (isNumeric(index) && (Integer.parseInt(index) <= 3 && Integer.parseInt(index) >= 0)) {
			Controller.feedAnimal(animals[Integer.parseInt(index)],0);
		}
	}
	...
	public static void usingHappyAgent() {
		...
		if (isNumeric(index) && (Integer.parseInt(index) <= 3 && Integer.parseInt(index) >= 0)) {
			Controller.useHappyAgent(items[Integer.parseInt(index)], 0);
		}
	}
	...
	public static void usingTimeAgent() {
		...
		if (isNumeric(index) && (Integer.parseInt(index) <= 5 && Integer.parseInt(index) >= 0)) {
			Controller.useTimeAgent(items[Integer.parseInt(index)],0);
		}
	}
